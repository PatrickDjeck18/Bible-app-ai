-- Create a function to create the dreams table (FIXED VERSION)
-- Run this in your Supabase SQL Editor

-- First, create the trigger function separately
...
-- Then create the main function to create the dreams table
