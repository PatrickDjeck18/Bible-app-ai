-- Fix for missing daily_activities table
-- Run this SQL in your Supabase SQL editor to resolve the "relation does not exist" error
...
SELECT 'daily_activities table created successfully!' as status;
